...
export default function VenueSelectionScreen() {
    ...
    const handleSubmitForApproval = async (venue: Venue) => {
        ...
        try {
            ...
            const seats = typeof eventData.requiredSeats === 'string'
                ? parseInt(eventData.requiredSeats)
                : (eventData.requiredSeats || 30);

            const durationHours = !isNaN(duration) ? duration / 60 : 2;
            const validSeats = !isNaN(seats) ? seats : 30;
