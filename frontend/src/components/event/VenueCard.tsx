        ...
        <View style={styles.card}>
            ...
            {venue.building && (
                <View style={styles.locationContainer}>
                    <Icon name="map-marker" size={16} color={THEME.colors.gray600} />
            ...
            <View style={styles.infoRow}>
                <View style={styles.capacityContainer}>
                    <Icon name="account-group" size={18} color={THEME.colors.gray700} />
            ...
            {(venue.occupiedTimes?.length > 0) && (
                <View style={styles.occupiedContainer}>
                    <Icon name="information" size={14} color={THEME.colors.warning} />
            ...
            {/* Selection Button */}
            {venue.isAvailable && showSelectButton && onSelect && (
                <Pressable
                    style={({ pressed }) => [
                        styles.selectButton,
                    ...
                    onPress={() => {
                        console.log('🔘 VenueCard: Button pressed for', venue.name);
                        console.log('🔘 VenueCard: Calling onSelect...');
                        if (onSelect) {
                            onSelect();
                        }
                    }}
            ...
            {/* Alternative Button */}
            {!venue.isAvailable && showAlternativeButton && onSuggestAlternative && (
                <TouchableOpacity
                ...
                >
                    ...
                    <Icon name="lightbulb-on" size={18} color={THEME.colors.primary} />
                </TouchableOpacity>
            )}
        </View>
    );
